...
function buildLibraryEsm(outDir: string): void {
  buildSync({
    entryPoints: {
      ...
      'extractors/hugging-face': path.join(SRC, 'extractors', 'hugging-face.ts'),
      'extractors/google-docs': path.join(SRC, 'extractors', 'google-docs.ts'),
      'extractors/google-ai-studio': path.join(SRC, 'extractors', 'google-ai-studio.ts'),
      'extractors/gemini-notebook': path.join(SRC, 'extractors', 'gemini-notebook.ts'),
